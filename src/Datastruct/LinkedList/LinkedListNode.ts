...
export default class LinkedListNode<NodeData = any> {
	...
	public insertBefore(data: NodeData): LinkedList<NodeData> {
		return this.list !== null ? this.list.insertBefore(this, data) : new LinkedList(data, this.data);
	}
	...
	public insertAfter(data: NodeData): LinkedList<NodeData> {
		return this.list !== null ? this.list.insertAfter(this, data) : new LinkedList(this.data, data);
	}
