...
import { LinkedList } from "wc3-treelib";
...
export const enum FLAG_ENGINE {
    ...
    PURE, // IS A DAMAGE THAT IGNORE ALL DAMAGE MODIFICATION THAT NOT SPECIFY PURE DAMAGE TYPE
...
export class Damage {
	...
	public static remove(dev: ListNode<OzDamageTrigger>) {
...
addScriptHook(W3TS_HOOK.MAIN_BEFORE, ()=>{
	try {
		...
		Logger.Error("Damage Engine", "Error during initialization");
		Logger.Error("Damage Engine", e);
	}
});